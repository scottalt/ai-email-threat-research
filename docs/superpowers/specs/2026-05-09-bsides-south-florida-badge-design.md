...
- **icon**: `⟐` (white concave-sided diamond with leftwards tick). Matches the geometric, terminal-friendly Unicode glyph style used elsewhere in the registry. Visually distinct from existing icons.
