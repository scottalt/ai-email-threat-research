...
Threat Terminal is a **free educational and research platform** that measures how humans detect AI-generated phishing emails. It is provided for educational and research purposes only.
...
- Use the platform in good faith for its intended educational and research purpose
- Not attempt to manipulate leaderboards, XP, or research data through automated means
- Not scrape, reverse-engineer, or extract the card dataset
- Not impersonate other players or abuse the social features
- Not use the platform's phishing content to conduct real attacks
...
The Threat Terminal name, interface, and game mechanics are the property of Scott Altiparmak. The AI-generated email content is created for this research study and may not be redistributed or used for malicious purposes.

---

## Limitation of liability

Threat Terminal is provided "as is" without warranty of any kind. To the maximum extent permitted by law, Scott Altiparmak shall not be liable for any damages arising from your use of this platform, including but not limited to any reliance on the educational content provided.
