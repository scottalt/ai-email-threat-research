-- Atomic H2H stats update: prevents race condition where concurrent match
-- finalizations read-then-write, overwriting each other's rank point changes.
-- Uses UPDATE ... SET col = col + delta pattern for atomic increment.
