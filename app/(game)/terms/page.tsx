...
export const metadata = {
  title: 'Terms of Use',
  description: 'Terms of use for Threat Terminal.',
};
...
const components: Components = {
  ...
  a: ({ href, children }) => (
    <a href={href} className="text-[var(--c-secondary)] underline hover:text-[var(--c-primary)] transition-colors">
      {children}
    </a>
  ),
};
...
export default function TermsPage() {
  const content = readFileSync(join(process.cwd(), 'docs/research/terms.md'), 'utf-8');
      ...
      <div className="w-full max-w-2xl space-y-4 mt-8 mb-12">
        <div className="term-border bg-[var(--c-bg)]">
          <div className="border-b border-[color-mix(in_srgb,var(--c-primary)_35%,transparent)] px-3 py-2">
            <span className="text-[var(--c-secondary)] text-sm tracking-widest">TERMS_OF_USE</span>
          </div>
